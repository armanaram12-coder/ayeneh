    ...
    return (
      <>
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-50 to-pink-50" dir="rtl">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">{error || 'سفارش یافت نشد'}</h1>
          <Link 
            href="/"
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 py-12" dir="rtl">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">شماره سفارش: <span className="font-bold text-gray-900">{order.order_number}</span></p>
            ...
            <div className="bg-yellow-50 rounded-lg p-4 mb-6 text-right border border-yellow-200">
              ...
              <p className="text-sm text-gray-900 mb-1"><strong className="text-gray-900">تلفن:</strong> {order.phone}</p>
              <p className="text-sm text-gray-900 mb-1"><strong className="text-gray-900">کد پستی:</strong> {order.postal_code}</p>
              <p className="text-sm text-gray-900"><strong className="text-gray-900">آدرس:</strong> {order.shipping_address}</p>
            </div>
                ...
                {items.length === 0 ? (
                  ...
                  items.map((item) => (
                    <div key={item.id} className="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                      ...
                      <span className="text-purple-600 font-bold">{item.price.toLocaleString()} تومان</span>
                    </div>
                  ))
                )}
              </div>
            ...
            <div className="border-t pt-6 mb-6">
              <div className="flex justify-between items-center text-lg font-bold">
                <span className="text-gray-900">مجموع کل:</span>
